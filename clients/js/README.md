...
> This library uses the new Solana [JavaScript SDK](https://www.npmjs.com/package/@solana/web3.js/v/2.0.0-rc.1). There is also a version of the library using the [Metaplex Umi framework](https://github.com/metaplex-foundation/umi).
